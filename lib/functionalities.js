...
var locks=[];
module.exports.createSchema = function(schema, callback){
...
module.exports.setSchemaFields = function(src, schema, callback){
	fs.readFile(src, 'utf8', function(err, data) {
...
module.exports.attachFieldToSchema = function(fields, field, callback){
...
module.exports.attachFieldObject = function(field){
...
module.exports.structureViews = function(fields, html, view, activeHtml) {
...
module.exports.checkStructureObject = function(structure, html, view, activeHtml) {
...
module.exports.structureRows = function(fields, html, view, activeHtml) {
...
module.exports.structureColumns = function(fields, html, view, activeHtml) {
...
module.exports.structureFile = function(html, file) {
	file = rms(file);
	html.ctrl.push(file);
...
module.exports.createStates = function(dest, states, name) {
...
module.exports.createControllers = function(dest, structure) {
	fs.readFile(dest, 'utf8', function(err, data) {
...
module.exports.structureInitialize = function(page) {
	var structureObj = {
		name: rms(page.name),
		ctrl: [],
		states: [],
...
module.exports.getFilesOfComponents = function(files) {
	var needFiles = [];
...
module.exports.createFilesFromTemplate = function(dest, folder, template, page, callback) {
...
module.exports.createScssFromTemplate = function(page) {
...
module.exports.createFile = function(src, dest, page, callback) {
	if (!fs.existsSync(dest)) {
		fs.readFile(src, 'utf8', function(err, data) {
...
module.exports.attachFieldToState = function(fields, state, data, name) {
...
module.exports.attachFieldToController = function(fields, name, data) {
...
// fix for production
module.exports.addProductionFiles = function(jsfiles, files) {
	return files;
};
module.exports.getContentBetween = function(data, from, to) {
	return data.split(from)[1].split(to)[0];
